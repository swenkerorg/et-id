...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@swenkerorg/et-id">
    <img alt="" src="https://img.shields.io/npm/v/@swenkerorg/et-id.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@swenkerorg/et-id.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@swenkerorg/et-id">
...
There is also a [Changelog](https://github.com/swenkerorg/et-id/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@swenkerorg/et-id';
...
```js
const classNames = require('@swenkerorg/et-id/dedupe');
...
```js
const classNames = require('@swenkerorg/et-id/bind');
...
import classNames from '@swenkerorg/et-id/bind';
